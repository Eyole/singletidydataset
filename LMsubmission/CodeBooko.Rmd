...
## 1) Set Working Directory with all the files:
```{r }
...
## 10) Combine the mean, std, activity and subjec data into one dataframe and find averages based on subject and activity. Display the resultant dataframe (df.single.tidy) and write it to a CSV file, {working directory}\single_tidy_dataset.csv.
